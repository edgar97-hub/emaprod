...
export const ViewLoteMolienda = () => {
  ...
  const obtenerDataProduccionRequisicionesDetalle = async () => {
    const resultPeticion = await viewMoliendaRequisicionId(id, codAgre);

    const { message_error, description_error, result } = resultPeticion;

    console.log(resultPeticion);
    var requisiciones = [];
    result[0].reqDet.map((obj) => {
      requisiciones.push({
    ...
    var ordenMolienda = {};
    ordenMolienda.desAre = "";
    ordenMolienda.desReqEst = "";
    ordenMolienda.fecEntReq = "";
    ordenMolienda.fecPedReq = "";
    ordenMolienda.id = "";
    ordenMolienda.idAre = "";
    ordenMolienda.idProdc = "";
    ordenMolienda.idReqEst = "";

    ordenMolienda.reqDet = requisiciones;
    result[0].agregaciones2 = [];
    result[0].agregaciones2[0] = ordenMolienda;
  ...
  return (
    <>
      <div className="container-fluid mx-3">
        <h1 className="mt-4 text-center">Orden de Molienda</h1>
