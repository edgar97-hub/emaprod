...
//helpers/produccion_lote/getProduccionLote
...
import { AccionesProduccionLote } from "./../../../produccion/components/AccionesProduccionLote";
import { updateFechasProduccion } from "./../../../produccion/helpers/produccion_lote/updateFechasProduccion";
...
export const ListAgregacion = () => {
  ...
  const obtenerDataProduccionLote = async (body = {}) => {
    ...
    if (idLotProdc.length !== 0) {
      ...
      var resultPeticion = await getAgregationsByOrderProduccion();
      const { result } = resultPeticion;
      const { AllAgregations, produccion } = result;
      console.log(resultPeticion)
      //setOrdenProduccion(produccion);
      setdataProduccionLote(AllAgregations.detAgr);
      setdataProduccionLoteTemp(AllAgregations.detAgr);
